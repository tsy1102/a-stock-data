...
## 源覆盖状态(2026-08-12,18 raw 文件)

- ✅ 已采(18 源): ZHB / TDX(TCP+F10×6) / 腾讯 88 / push2(58) / push2_full(114) / ulist239(239 批量) / 新浪 34 / AxData 34 / 财联社(情绪+快讯) / KPL / 板块轮动 / thsdk(收盘不可用) / push2ex 涨停炸板池 / 东财人气榜 / datacenter(两融/北向/解禁) / 巨潮互动易 / 研报 reportapi / 龙虎榜
- ⏳ 待采: 
  ...
  - 新浪财务/龙虎榜、交易所直连、fuyao(无 key)、akshare/eltdx(文档级未实测)
  - push2 5 主机(1.push2/2.push2/83.push2)字段差异对比: 待 push2 系恢复窗口(2026-08-12 实测 5 主机全拒,push2delay 兜底 114 字段)
  - em_hot 0 条、跌停池 0 条: 接口参数待查
